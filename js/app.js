...
var fgElements = [...document.querySelectorAll('[data-fg]')]
var bgElements = [...document.querySelectorAll('[data-bg]')]

function updateFgSlow(color) {
    fgElements.forEach(function (element) {
        console.log(element)
        element.jscolor.fromString(color.toString())
    })
}

function updateBgSlow(color) {
